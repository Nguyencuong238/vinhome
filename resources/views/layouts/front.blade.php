...
<head>
    ...
    @else
        ...
        <meta name="description"
            content="Vinhomes Green Paradise Cần Giờ - Siêu đô thị lấn biển 2.870ha, vốn đầu tư 10 tỷ USD. Paradise Lagoon 443ha, sân golf Tiger Woods, Marina 5 sao. Hotline: 0963 72 85 86">
        <meta name="keywords"
...
<body>
    ...
    <header class="header">
        <div class="container">
            <nav class="navbar">
                <div class="logo">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="Green Paradise">
                </div>
                <ul class="nav-menu">
